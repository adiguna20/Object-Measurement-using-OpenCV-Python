...
while 1:
    ...
    #-------------------------------
        ...
        for c in contours:
            ...
            xlen = (abs(x1c-x2c))*x_kal
            ylen = (abs(y1c-y2c))*y_kal
            alen = 0
            ...
            draw.add_text(frame0,f'Luas Object: {carea:.2f} cm2',x3,y2+8,center=True,top=True,color='red')
            if alen:
                draw.add_text(frame0,f'Rata-rata: {alen:.2f}',x3,y2+34,center=True,top=True,color='green')
            if x1 < width-x2:
    ...
    #-------------------------------
        ...
        if mouse_mark:
            ...
            # add dimensions
            draw.add_text(frame0,f'{xlen:.2f}',x1-((x1-x2)/2),min(y1,y2)-8,center=True,color='red')
            draw.add_text(frame0,f'Luas Object: {carea:.2f} cm2',x3,y3+8,center=True,top=True,color='red')
            if alen:
                draw.add_text(frame0,f'Rata-rata: {alen:.2f}',x3,y3+34,center=True,top=True,color='green')           
            if x2 <= x1:
